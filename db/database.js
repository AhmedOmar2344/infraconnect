...
async function initDb() {
  ...
  await db.exec(`
    INSERT INTO categories (name, slug, description, icon, sort_order, category_type) VALUES
      ('Air Conditioners','air-conditioners','Split and window air conditioners','wind',20,'consumer'),
      ('Smart Watches','smart-watches','Smartwatches and fitness trackers','watch',21,'consumer'),
      ('Home Appliances','home-appliances','Kitchen and home appliances','home',22,'consumer'),
      ('Headphones & Audio','headphones-audio','Headphones, earbuds and speakers','headphones',23,'consumer'),
      ('PC Components','pc-components','Cases, coolers, PSUs, motherboards and internal parts','cpu',24,'consumer'),
      ('Computer Peripherals','computer-peripherals','Mice, keyboards, webcams and hubs','mouse',25,'consumer'),
      ('Mobile Accessories','mobile-accessories','Cables, chargers, cases and phone accessories','smartphone',26,'consumer'),
      ('Bags & Sleeves','bags-sleeves','Laptop bags, sleeves and cases','briefcase',27,'consumer'),
      ('Televisions','televisions','Smart TVs and displays','tv',28,'consumer')
